  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex flex-wrap gap-10 items-center px-3 justify-center ">
        ...
        >
          <Image
            src="/Images/MainImages/4images/Untitled-1.png3.png" // تصویر کیبورد
            alt="کیبورد"
            priority={true}
            width={80}
            height={80}
        ...
        >
           <Image
            src="/Images/MainImages/4images/Untitled-1.png4.png" // تصویر آیپد
            alt="آیپد"
            priority={true}
            width={80}
            height={80}
        ...
        >
          <Image
            src="/Images/MainImages/4images/Untitled-1.png5.png" // تصویر هدفون
            alt="هدفون"
            priority={true}
            width={80}
            height={80}
        ...
        >
          <Image
            src="/Images/MainImages/4images/Untitled-1.png1.png" // تصویر هدفون
            alt="هدفون"
            priority={true}
            width={80}
            height={80}
