  ...
  return (
    <div className="flex flex-wrap gap-28 mx-auto mt-28  justify-center">
      <div className="flex items-center gap-5">
        <Image
          src="/Images/MainImages/Servicesimg/free-delivery.png"
      ...
      <div className="flex items-center gap-5">
        <Image
          src="/Images/MainImages/Servicesimg/24-hours.png"
          alt="Description of the image"
          className="sm:w-[80px] sm:h-[80px]"
          priority={true}
          width={50}
      ...
      <div className="flex items-center gap-5">
        <Image
          src="/Images/MainImages/Servicesimg/checked.png"
          alt="Description of the image"
          className="sm:w-[80px] sm:h-[80px]"
          priority={true}
          width={50}
      ...
      <div className="flex items-center gap-5">
        <Image
          ...
          src="/Images/MainImages/Servicesimg/secure-payment.png"
          className="sm:w-[80px] sm:h-[80px]"
          alt="Description of the image"
          priority={true}
          width={50}
