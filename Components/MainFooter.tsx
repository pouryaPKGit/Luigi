...
const MainFooter: React.FC = () => {
  return (
    <div className="w-[100%] min-h-[500px] bg-[#181818] mt-32 pb-5">
      <div className="flex flex-wrap items-center justify-between px-10 smpx-16  md:px-32 pt-16">
        <div className="flex items-center gap-2">
          <Link href="/">
            <Image
              src="/Images/HeaderImages/Untitled-1.png1.png"
      ...
      <div className="sm:pr-32 pt-10 pr-10">
        <p className="text-xl font-bold">| Developed By: Pourkhani |</p>
      </div>
    </div>
  );
};
