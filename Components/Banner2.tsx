...
const Banner2: React.FC = () => {
  return (
    <div className='flex flex-wrap gap-10 mt-28 justify-center mx-10'>
      <div className='relative' data-aos="fade-down-left">
        <Image
          src="/Images/Footer/Banner2/photo_2024-09-16_17-18-58.jpg1.jpg"
      ...
      <div className='relative' data-aos="fade-down-right">
        <Image
          src="/Images/Footer/Banner2/photo_2024-09-16_17-19-09.jpg0002.jpg"
          alt="Description of the image"
          priority={true}
          className='cursor-pointer shadow-md rounded-xl shadow-white hover:opacity-75 duration-300'
          width={650} 
